...
** let emacs recognize foots terminfo

#+begin_src emacs-lisp
(add-to-list 'term-file-aliases '("foot" . "xterm"))
(add-to-list 'term-file-aliases '("foot-extra" . "xterm"))
#+end_src
...
(use-package languagetool
  ...
  (setq languagetool-java-arguments '("-Dfile.encoding=UTF-8")
        ...
        languagetool-console-arguments '("--languagemodel" "/usr/share/ngrams")
        languagetool-server-arguments  '("--languagemodel" "/usr/share/ngrams")
